...
class TestCEEView(unittest.TestCase):
    ...
    def test_get_task(self):
        """CEEView - GET on /api/1/inf/cee returns a task-id"""
    ...
    def test_post_task(self):
        """CEEView - POST on /api/1/inf/cee returns a task-id"""
        resp = self.app.post('/api/1/inf/cee',
                             headers={'X-Auth': self.token},
    ...
    def test_delete_task(self):
        """CEEView - DELETE on /api/1/inf/cee returns a task-id"""
        resp = self.app.delete('/api/1/inf/cee',
                               headers={'X-Auth': self.token},
                               json={'name': "myCEE"})
    ...
    def test_get_image_task(self):
        """CEEView - GET on /api/1/inf/cee/image returns a task-id"""
        resp = self.app.get('/api/1/inf/cee/image',
                            headers={'X-Auth': self.token})
