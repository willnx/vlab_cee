...
DEFINED = OrderedDict([
            ('VLAB_CEE_LOG_LEVEL', environ.get('VLAB_CEE_LOG_LEVEL', 'INFO')),
            ...
            ('VLAB_MESSAGE_BROKER', environ.get('VLAB_MESSAGE_BROKER', 'cee-broker')),
            ('VLAB_URL', environ.get('VLAB_URL', 'https://localhost')),
            ('VLAB_CEE_IMAGES_DIR', environ.get('VLAB_CEE_IMAGES_DIR', '/images')),
          ])
